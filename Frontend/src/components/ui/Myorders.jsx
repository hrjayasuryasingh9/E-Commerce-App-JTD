...
const ProductCard = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch(
        `https://e-commerce-app-jtd-b0ky.onrender.com/api/orders/user/getorders/${userId}`,
        {
          method: "GET",
          headers: {
  ...
  const handleDecline = async (index) => {
    ...
    try {
      const response = await fetch(
        `https://e-commerce-app-jtd-b0ky.onrender.com/api/orders/user/deleteorder/${orderId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
